...
class MasterMPO:
    def __init__(self, num_gpu_ranks, n, m, d, r, loss, init_chi, chi, errtol = 10 ** (-6), PS = None):
    ...
    def MPOInitialization(self):
        ...
        self.Lambda_edge = np.ones(init_chi, dtype = 'float32') # edge lambda (for first and last site) don't exists and are ones
